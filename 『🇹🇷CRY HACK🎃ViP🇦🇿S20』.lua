...
for ANT = 1,5 do
gg.toast("❤️https://t.me/CRYHacktr❤️")
...
gg.sleep(300)
gg.toast("■■■■■■■100%")
gg.alert("🇹🇷CRY VİP SCRİPT TE HOŞ GELDİNİZ🇹🇷")
gg.alert("[⚡TAMAMEN RANK İÇİN AYARLANMİSTİR⚡]️")
gg.alert("[💙ÇOK FAZLA BELLİ ETMEYİNİZ💙]")
gg.setVisible(true)
PUBGMH = -1
function HOME()
MENU = gg.choice({
